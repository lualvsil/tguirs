...
// limitations under the License.// Generated by gl-generator<
        mod __gl_imports {
            pub use std::mem;
            pub use std::os::raw;
        }
...
#[allow(dead_code)]
pub type khronos_utime_nanoseconds_t = u64; //super::khronos_utime_nanoseconds_t;
#[allow(dead_code)]
pub type khronos_uint64_t = u64; //super::khronos_uint64_t;
#[allow(dead_code)]
pub type khronos_ssize_t = isize; //super::khronos_ssize_t;
pub type EGLNativeDisplayType = *mut std::os::raw::c_void; //super::EGLNativeDisplayType;
#[allow(dead_code)]
pub type EGLNativePixmapType = *mut std::os::raw::c_void;//super::EGLNativePixmapType;
#[allow(dead_code)]
pub type EGLNativeWindowType = *mut std::os::raw::c_void;//super::EGLNativeWindowType;
pub type EGLint = i32;
#[allow(dead_code)]
...
#[allow(dead_code, non_upper_case_globals)] pub const NATIVE_BUFFER_ANDROID: types::EGLenum = 0x3140;
...
#[allow(non_snake_case, unused_variables, dead_code)] #[inline]
            pub unsafe fn GetNativeClientBufferANDROID(buffer: *const __gl_imports::raw::c_void) -> types::EGLClientBuffer { __gl_imports::mem::transmute::<_, extern "system" fn(*const __gl_imports::raw::c_void) -> types::EGLClientBuffer>(storage::GetNativeClientBufferANDROID.f)(buffer) }
#[allow(non_snake_case, unused_variables, dead_code)] #[inline]
...
pub static mut WaitSync: FnPtr = FnPtr {
            ...
            pub mod GetNativeClientBufferANDROID {
                ...
                #[allow(dead_code)]
                pub fn is_loaded() -> bool {
                    unsafe { storage::GetNativeClientBufferANDROID.is_loaded }
                }

                #[allow(dead_code)]
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&'static str) -> *const raw::c_void {
                    unsafe {
                        storage::GetNativeClientBufferANDROID = FnPtr::new(metaloadfn(&mut loadfn, "eglGetNativeClientBufferANDROID", &[]))
                    }
                }
            }
...
GetNativeClientBufferANDROID::load_with(&mut *loadfn);
